...
import 'package:covid_19_tracker/counter.dart';
import 'package:covid_19_tracker/countrydata.dart';
import 'package:covid_19_tracker/select_Country.dart';
import 'package:covid_19_tracker/parser.dart';
import 'package:covid_19_tracker/settings_Dialog.dart';
          ...
          children: <Widget>[
            ...
            Row(
              ...
              children: <Widget>[
                Text(
                  'Total Cases:',
                  style: TextStyle(color: Color(0xffFFFC00), fontSize: 22, fontWeight: FontWeight.bold),
                ),
                Counter(
                  textStyle: TextStyle(color: Color(0xffFFFC00), fontSize: 22, fontWeight: FontWeight.bold),
                  animation: new StepTween(
                    begin: 0, //prevTotalCases,
            ...
            Row(
              ...
              children: <Widget>[
                Text(
                  'Cases per Million:',
                  style: TextStyle(color: Color(0xffFFFC00), fontSize: 18),
                ),
                Counter(
                  textStyle: TextStyle(color: Color(0xffFFFC00), fontSize: 18),
                  animation: new StepTween(
                    begin: 0, //prevTotalCases,
